...
pcd = o3d.io.read_point_cloud(".\imagen_columna\imagen_columna.ply")
...
with o3d.utility.VerbosityContextManager(
    ...
    labels = np.array(
        pcd.cluster_dbscan(eps=0.0018, min_points=50, print_progress=True)) # con imagenes donde objeto tiene depth parecido eps=0.0018 , y cuando no  eps=0.003
